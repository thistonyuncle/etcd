...
import (
	...
	"github.com/thistonyuncle/etcd/etcdserver/auth"
	"github.com/thistonyuncle/etcd/pkg/logutil"
)
...
var (
	plog = capnslog.NewPackageLogger("github.com/thistonyuncle/etcd", "etcdserver/api/v2http")
